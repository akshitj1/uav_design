...
class MissionParams:
    def __init__(self) -> None:
        ...
        self.cruise_distance = 2*self.charge_point_distance+delivery_distance
        self.cruise_height = 150
...
class UavParams:
    def __init__(self, mission_params: MissionParams) -> None:
        ...
        self.payload_area = utils.square_area(utils.inch_to_m(12))

        # tip to tip excluding fuselage
        self.wing_span = 1.2
        self.aspect_ratio = 6.0
        ...
        # zero value init
        self.battery_mass = 0
        self.cruise_speed = utils.kmph_to_mps(100)
        self.climb_speed = 4
        self.land_speed = 4

        self.horizontal_prop_radius = utils.inch_to_m(12)/2
        self.vertical_prop_radius = self.horizontal_prop_radius
        self.vertical_prop_thrust_max=2.5*self.gravity
    ...
    def structural_mass(self):
        return self.estimate_wingcopter_structure_mass()
